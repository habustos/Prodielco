# Generated by Django 2.2.10 on 2021-03-22 22:33
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('departamento', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Diagnosticos.Depto')),
                ('municipio', smart_selects.db_fields.ChainedForeignKey(auto_choose=True, chained_field='departamento', chained_model_field='departamento', on_delete=django.db.models.deletion.CASCADE, to='Diagnosticos.Municipio')),
            ],
        ),
        migrations.CreateModel(
            name='Tap_Nominal',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('responsable', smart_selects.db_fields.ChainedForeignKey(auto_choose=True, chained_field='cliente', chained_model_field='cliente', on_delete=django.db.models.deletion.CASCADE, to='Diagnosticos.Responsable')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cliente', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Diagnosticos.Cliente')),
                ('tipo_prueba', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Diagnosticos.Tipo_Pruebas')),
                ('transformador', smart_selects.db_fields.ChainedForeignKey(auto_choose=True, chained_field='cliente', chained_model_field='cliente', on_delete=django.db.models.deletion.CASCADE, to='Diagnosticos.Transformador')),
            ],
        ),
        migrations.CreateModel(
            name='Conexion_TTR',
        ...
        migrations.AddField(
            model_name='cliente',
            name='municipio',
            field=smart_selects.db_fields.ChainedForeignKey(auto_choose=True, chained_field='departamento', chained_model_field='departamento', on_delete=django.db.models.deletion.CASCADE, to='Diagnosticos.Municipio'),
        ),
    ]
